...
IF NOT EXISTS (
  SELECT 1 FROM pg_tables 
  WHERE tablename = 'scorecard_players' 
  AND rowsecurity = true
) THEN
...
IF NOT EXISTS (
  ...
  WHERE tablename = 'scorecards' 
  AND policyname = 'Users can create their own scorecards'
) THEN
...
IF NOT EXISTS (
  SELECT 1 FROM pg_policies 
  WHERE tablename = 'scorecards' 
  AND policyname = 'Users can view their own scorecards'
) THEN
...
IF NOT EXISTS (
  SELECT 1 FROM pg_policies 
  WHERE tablename = 'scorecards' 
  AND policyname = 'Users can update their own scorecards'
) THEN
...
IF NOT EXISTS (
  SELECT 1 FROM pg_policies 
  WHERE tablename = 'scorecard_players' 
  AND policyname = 'Users can create scorecard players for their scorecards'
) THEN
...
IF NOT EXISTS (
  SELECT 1 FROM pg_policies 
  WHERE tablename = 'scorecard_players' 
  AND policyname = 'Users can view scorecard players for their scorecards'
) THEN
...
IF NOT EXISTS (
  SELECT 1 FROM pg_policies 
  WHERE tablename = 'scorecard_players' 
  AND policyname = 'Users can update scorecard players for their scorecards'
) THEN
